       ...
       /*Rafael*/ static string url = "Data Source=DESKTOP-4Q8D704;Initial Catalog=Projeto;User ID=sa;Password=123456";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                VALUES(@nome, @cpf, @email, @data, @endereco, @municipio, @bairro, @comp, @telefone, @curso, 'pr')";
                SqlCommand cm = new SqlCommand();
                cm.Connection = cn;
        ...
        private void buttonLimpar_Click_2(object sender, EventArgs e)
        {
            LimparCampos();
        }

        private void retornarToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Deseja mesmo retornar?", "Retornar", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                Close();
        }
